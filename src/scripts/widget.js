...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const iconContainer = document.querySelector('.temp');
  ...
  const displayCurrentWeather = (data) => {
    ...
    if (dayData) {
      const weatherIcon = `<img class="" src="http://openweathermap.org/img/wn/${icon}.png">
      <span class="location">Kyiv, UA</span>
